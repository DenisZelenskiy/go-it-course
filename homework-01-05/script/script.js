 ...
 */
const getUsersByEyeColor = users.filter(el => el.eyeColor === 'blue');
console.log(getUsersByEyeColor); // [объект Moore Hensley, объект Sharlene Bush, объект Carey Barr]

                                            
// /**
//  * Получить массив имен пользователей по полу (поле gender)
//  */
const getUsersByGender = (arr, gender) => arr.filter(el => el.gender === 'male');
